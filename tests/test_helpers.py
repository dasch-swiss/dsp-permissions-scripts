...
def test_sort_groups() -> None:
    groups_original = [
        group.BuiltinGroup.from_prefixed_iri("knora-admin:C_CustomGroup"),
        group.UNKNOWN_USER,
        group.PROJECT_ADMIN,
        group.PROJECT_MEMBER,
        group.CREATOR,
        group.BuiltinGroup.from_prefixed_iri("knora-admin:A_CustomGroup"),
        group.BuiltinGroup.from_prefixed_iri("knora-admin:B_CustomGroup"),
        group.KNOWN_USER,
        group.SYSTEM_ADMIN,
    ]
    groups_expected = [
